      ...
      <div style={{ padding: "40px 24px", display: "flex", flexDirection: "column", alignItems: "center" }}>
        ...
        <div style={{ width: "100%", marginBottom: "40px" }}>
          ...
          {!isBrand && portfolio.length > 0 && (
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 170px)", gap: "2px", justifyContent: "center" }}>
              {portfolio.map(img => (
                <div key={img.id} style={{ position: "relative", width: "170px", height: "170px", overflow: "hidden", backgroundColor: "rgba(255,255,255,0.04)" }}>
          ...
          {isBrand && (
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 170px)", gap: "2px", justifyContent: "center" }}>
              {Array.from({ length: 9 }).map((_, i) => {
                ...
                return (
                  <label key={`empty-${i}`} style={{ width: "170px", height: "170px", border: "1px dashed rgba(201,169,110,0.2)", display: "flex", alignItems: "center", justifyContent: "center", cursor: portfolio.length < 9 ? "pointer" : "default", backgroundColor: "rgba(255,255,255,0.02)" }}>
